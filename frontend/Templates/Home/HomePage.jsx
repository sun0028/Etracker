...
const HeroSection = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-pink-400 to-cyan-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-white text-pink-500 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
        </div>
